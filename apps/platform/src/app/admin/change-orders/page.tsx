  ...
  return (
    <PlatformFrame active="change-orders" roles={context.roles} userEmail={context.user.email}>
      <div className="shell app-content commerce-page">
        <section className="page-heading commerce-heading"><div><p className="surface-label"><FilePlus2 size={18} /> Scope control</p><h1>Change orders</h1><p>Price and approve additional work without rewriting the original quote.</p></div><Link className="primary-action" href="/admin/change-orders?new=1"><Plus size={18} /> New change order</Link></section>
